...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code=="1"){
						...
						htmlStr+="<a class=\"myHref\" name=\"editA\" remark-id=\""+data.data.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
						htmlStr+="&nbsp;&nbsp;&nbsp;&nbsp;";
						htmlStr+="<a class=\"myHref\" name=\"deleteA\" remark-id=\""+data.data.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
						htmlStr+="</div>";
						htmlStr+="</div>";
						htmlStr+="</div>";
		...
		//给每一个"修改"图标添加单击事件:采用on、每一个修改图标的目标元素
			...
			$.ajax({
				...
				success:function (data) {
					if(data.code=="1"){
						...
						//更新市场活动备注列表
						$("#div_"+id+" h5").html(data.data.noteContent);
...
<body>
	...
	<div id="remarkListDiv" style="position: relative; top: 30px; left: 40px;">
        ...
        <c:if test="${not empty activityRemarkList}">
                ...
                <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
                    ...
                    <div style="position: relative; top: -40px; left: 40px;" >
                        ...
                        <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                            <a class="myHref" remark-id="${remark.id}" name="editA" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="myHref" remark-id="${remark.id}" name="deleteA" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
                        </div>
                    </div>
                </div>
            </c:forEach>
